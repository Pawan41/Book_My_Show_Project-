...
const NavMd = () => {
    return (
        <div className="w-full m-3 px-4 py-2 flex items-center gap-2 bg-white rounded-md">
            <BiSearch />
        ...
        <>
            <div className="container mx-auto px-4  flex items-center justify-between ">
                <div className="flex items-center w-1/2 gap-3 ">
                    ...
                    <div className="w-full my-2 px-4 py-2 flex items-center gap-2 bg-white rounded-md">
                        <BiSearch />
                        <input type="search" className="w-full bg-transparent border-none focus:outline-none" placeholder="Search for movies, events, Plays, Sports and Activities." />
                    </div>
                </div>
